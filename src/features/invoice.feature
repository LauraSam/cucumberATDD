Feature: Get the input field for front end part
    ...
    Scenario: Translate 
        ...
        Then I expect that element ".menu li" matches with the text "YOUR INVOICE"  
        And I wait on element ".menu li:first-child" to contain a text
        When I click on the link ".menu li:first-child"
