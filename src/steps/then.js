...
/*import checkElementDOMPosition from '../support/check/checkElementDOMPosition'*/
...
import checksTextInDOM from '../support/check/checksTextInDOM';
...
defineSupportCode(({ Then }) => {
    Then(
     ...
     Then(
        /^I expect that element "([^"]*)?" matches( not)* with the text "([^"]*)?"$/,
        checksTextInDOM
    );
   /*   Then(
        /^I expect that the element is( not)* "([^"]*)?"$/,
        checkElementDOMPosition
    );*/
